/*
 * Copyright (C) 2015 Miroslaw Stanek
 *
...
package com.pizidea.coolplay.widget.drawer;
    ...
    public static class DrawerBuilder {
        ...
        private void setupToggler(final DrawerLayout drawerLayout) {
            if (toolbar != null) {
                ...
                ActionBarDrawerToggle mDrawerToggle = new ActionBarDrawerToggle(activity, drawerLayout, toolbar, R.string.app_name,R.string.app_name);
